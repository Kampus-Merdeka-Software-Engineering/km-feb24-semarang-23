function displayLastUpdatedDate() {
  ...
  function getUniqueNamePizzaByCategory(jsonData, selectedCategory) {
    const uniqueNamePizza = new Set();
    for (const item of jsonData) {
  ...
  function updateFilters(jsonData, filterCategory, filterName, filterMonth) {
    ...
    const uniqueNamePizza = getUniqueNamePizzaByCategory(jsonData, filterCategory);
    const uniqueMonth = getUniqueMonth(jsonData);
  
    populateFilterElement("categoryFilter", uniqueCategories, filterCategory);
    populateFilterElement("nameFilter", uniqueNamePizza, filterName);
    populateFilterElement("monthFilter", uniqueMonth, filterMonth);
